...
//
//	    **【未解決】上端が上階のレベルにちょうど届く柱が、実体を持たないことがある。** 実機
//	    （スキップフロアのモデル）で 1 階の管柱 46 本がそうなった——パス長 2959 の柱で
//	    StartElevation=572 / EndElevation=572。**原因はまだ分かっていない。**
...
//	    したがって**高さ基準の書き方を変える直し方はもう試さない**。いま疑っているのはパスで、
//	    図面上のパスの頂点を読み戻して診断へ載せてある（`draw/DrawUtil` の `DescribePioPath`）。
