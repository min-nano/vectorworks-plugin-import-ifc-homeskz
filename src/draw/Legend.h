...
namespace HomeskzIfcImport::draw
{
	...
	//
	// ★**縮率は 2 か所にあり、こちらから動かせるのは片方だけ**（実機で 1 つずつ確かめた）:
	//
	//   | 何が | どこで決まる | プラグインから |
	//   | --- | --- | --- |
	//   | イメージの**中身**の縮尺 | 凡例イメージ（＝ビューポート）の縮尺 | **書ける** |
	//   | セルの**枠**・OIP の表示 | レコードの `ImageScale` | **書いても戻される** |
	//
	// ここでやるのは**中身だけ**。枠は既定（1:50）のまま残るので、伏図がそれと違う縮尺のとき
	// セルが中身より少し広くなる（docs/DEV-NOTES.md「打ち切った調査」の
	// 「凡例の枠を伏図の縮尺に合わせる」／README「既知の制限」）。
	//
