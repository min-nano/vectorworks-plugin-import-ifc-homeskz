...
//	"床束2" のどちらが要る絵かは名前からは決まらない）。そこで選択は**サムネイル付きの
...
namespace HomeskzIfcImport::draw
{
	...
	//
	// 選択肢は**いま開いている図面のシンボル定義**（名前順）だけ——ポップアップの項目は
	// 実在するリソースなので、そもそも図面に無い名前は項目にできない。プラグインはシンボル
	// 定義を作らない（draw/Symbol.cpp）ので、図面に無いものは置きようがなく、その要素は
